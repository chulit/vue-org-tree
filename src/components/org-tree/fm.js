...
const isLeaf = (data, prop) => {
  ...
  export const renderNode = (h, data, context) => {
    ...
    if(data[props.props.couple]){
        childNodes.push([renderLabel(h, data, context),renderLabel(h, data[props.props.spouse], context)])
    }else{
  ...
  export const renderLabel = (h, data, context) => {
    ...
    if(data[props.props.couple]){
     spouse = data[props.props.spouse]
    } 
  ...
  export const render = (h, context) => {
    ...
    console.log(h,context, renderNode(h, props.data, context))
